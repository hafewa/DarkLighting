...
public class PlayerStatus : MonoBehaviour {
	...
	public SubAttribute statusAdd; //次级属性 来源装备 技能add status(from equip,skill)
	...
	public float hpRegenTime; //自身的生命回复hp regen per second
	public float mpRegenTime; //自身的魔法值回复mp regen per second
	...
	void Start () {
		...
		Invoke("SettingStatus",0.1f);//0.1秒后调用SettingStatus方法
        alreadyApply = true;
