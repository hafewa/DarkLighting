...
public class HeroController : MonoBehaviour {
	...
	{		
		...
		}else if(delayAttack <= 0)
		{
			...
			if(checkCritical)
			{
				typeAttack = UnityEngine.Random.Range(0,animationManager.criticalAttack.Count);
				animationManager.checkAttack = false;
			}else if(!checkCritical)
			{
				typeAttack = UnityEngine.Random.Range(0,animationManager.normalAttack.Count);
				animationManager.checkAttack = false;
			}
	...
	{
		float calCritical = criticalStat - UnityEngine.Random.Range(0,101f);
